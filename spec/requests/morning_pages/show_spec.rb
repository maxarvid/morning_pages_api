describe 'GET /morning_pages/:id', type: :request do
  ...
  let!(:other_morning_page) { create(:morning_page) }
  ...
  describe 'when user is authenticated' do
    ...
    it 'is expected to return the body of the morning page belonging to the user' do
      expect(response_json['morning_page']['body']).to eq morning_page.body
    end
  end

  describe 'when user is authenicated but morning page belongs to another user' do
    before do
